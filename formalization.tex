...
\inferrule[\textsc{Proc-PopReq}] {
  ...
  process(h, {\PopReq {h'} {\iota'}}, \sigma, h') = (m', \sigma'')
}
...
\inferrule[\textsc{Proc-Req}] {
  ...
  process(h, {\Req {h'} r \iota}, \sigma, h') = (m', \sigma)
}
...
\inferrule[\textsc{R-ProcQueue}] {
  (m', \sigma'') = process(h, m, \sigma, h')
} {
