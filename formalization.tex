...
% 6.
\item By 2.b), 4., 5., and WF-Host2, $\Sigma' \vdash H'$.
\end{enumerate}
...
% 17.
\item By 2.b), 4.b), 14., 16., and WF-Host2, $\Sigma \vdash H'$.
\end{enumerate}
...
% 14.
\item By 12.a), 12.c), 13., and WF-HostConfig, $\Sigma \vdash (t', \sigma', Q' \cdot m)^{h'}$.
% 15.
\item By 2.b), 3.c), 10., 14., and WF-Host2, $\Sigma \vdash H'$.
\end{enumerate}

\item Case R-ProcQueueRemote.
\begin{enumerate}
% 1.
\item By the assumptions
  \begin{enumerate}[label=(\alph*)]
...
\item By 3.a) and WF-HostConfig
  ...
  \end{enumerate}
% 5.
\item By 2.c), 4.b), and WF-Q1-3
  \begin{enumerate}[label=(\alph*)]
  \item $\Sigma \vdash Q''$
  \item $\Sigma \vdash m \cdot \epsilon$
  \end{enumerate}
% 6.
\item By 4.a-c), 5.a), and WF-HostConfig, $\Sigma \vdash (E[\texttt{await}(\iota)], \sigma, Q'')^h$.
% 7.
\item By 3.b) and WF-HostConfig
  \begin{enumerate}[label=(\alph*)]
  \item $\Sigma \vdash \sigma'$
...
\item By 4.a), 5.b), 2.d), and Lemma~\ref{lem:process}
  ...
  \end{enumerate}
% 9.
\item By 5.a), 8.c), and WF-Q1-3, $\Sigma' \vdash Q''$.
% 10.
\item By 4.c), 8.c), and part 1 of Lemma~\ref{lem:weakening-store-typing}, $\Gamma ; \Sigma' \vdash E[\texttt{await}(\iota)] : T$.
% 11.
\item By 8.a), 9., 10., and WF-HostConfig, $\Sigma' \vdash (E[\texttt{await}(\iota)], \sigma'', Q'')^h$.
% 12.
\item By 7.a), 8.c), and WF-Store2, $\Sigma' \vdash \sigma'$.
% 13.
\item By 7.b), 8.c), WF-Q1-3, $\Sigma' \vdash Q'$.
% 14.
...
% 16.
\item By 12., 14., 15., and WF-HostConfig, $\Sigma' \vdash (t', \sigma', Q' ::: \hat{Q})^{h'}$.
% 17.
\item By 3.c), 8.c), and part 3 of Lemma~\ref{lem:weakening-store-typing}, $\Sigma' \vdash H''$.
% 18.
\item By 11., 16., 17., WF-Host2, $\Sigma' \vdash H'$.
\end{enumerate}
